...
#client_key = "actual client_key"
#client_secret =  "actual client_secret"
#access_token =  "actual access_token"
#access_token_secret =  "actual access_token_secret"
...
def construct_unique_key(baseurl, params):
    ...
    unique_key = baseurl + separator + separator.join(key_value_pair)
    return unique_key
...
def make_request_with_cache(baseurl, hashtag, count):
    ...
    if request_result in CACHE_DICT.keys():
        ...
        return CACHE_DICT[request_result]
    else:
        print("making new request")
        CACHE_DICT[request_result] = make_request(baseurl, params)
